        ...
        public async Task<IActionResult> Register(RegisterDTO model)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    ViewBag.Error = "Email already exists or registration failed. Please try with a different email address or check your inputs.";
                    _logger.LogWarning("Registration failed for {Email}", model.Email);
                }
            }
            catch (Exception ex)
            {
                ViewBag.Error = "An error occurred during registration. Please verify your internet connection and try again.";
